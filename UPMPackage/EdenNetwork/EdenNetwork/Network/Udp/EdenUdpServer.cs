	...
	public class EdenUdpServer : IEdenNetServer
	{
		...
		public void SetNatRequestListener()
		{
			...
			_punchListener.NatIntroductionRequest += (localEndPoint, remoteEndPoint, additionalData) =>
			{
				...
				{
					_netManager.NatPunchModule.NatIntroduce(hostEndPoint.LocalEndPoint.ToIPEndPoint(), hostEndPoint.RemoteEndPoint.ToIPEndPoint(), localEndPoint, remoteEndPoint, additionalData);
				}
			};
		}
