...
namespace EdenNetwork
{
    public class EdenNetServer
    {
        ...
        /// case 2. Cannot open stream for log file path
        /// </exception>
        public EdenNetServer(string ipv4_address, int port) : this(ipv4_address, port, "EdenNetServerLog.txt") { }
        /// <summary>
        /// Constructor for EdenNetSerer
        /// </summary>
        /// <param name="port">Port number to open server</param>
        ...
        /// case 2. Cannot open stream for log file path
        /// </exception>
        public EdenNetServer(int port) : this("0.0.0.0", port, "EdenNetServerLog.txt") { }
        #endregion
        /// <summary>
